...
namespace Sistema_Escolar1 {
    ...
    public partial class studentsDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentsRow AddStudentsRow(string Name, string LastName, System.DateTime Birthday) {
            ...
            public System.DateTime Birthday {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'Birthday\' de la tabla \'Students\' es DBNull.", e);
                    }
                }
                set {
...
namespace Sistema_Escolar1.studentsDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Students] WHERE (([idStudent] = @Original_idStudent) AND ([Nam" +
                "e] = @Original_Name) AND ([LastName] = @Original_LastName) AND ((@IsNull_Birthda" +
                "y = 1 AND [Birthday] IS NULL) OR ([Birthday] = @Original_Birthday)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([Name], [LastName], [Birthday]) VALUES (@Name, @Las" +
                "tName, @Birthday);\r\nSELECT idStudent, Name, LastName, Birthday FROM Students WHE" +
                "RE (idStudent = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [Name] = @Name, [LastName] = @LastName, [Birthday] = @Birthday WHERE (([idStudent] = @Original_idStudent) AND ([Name] = @Original_Name) AND ([LastName] = @Original_LastName) AND ((@IsNull_Birthday = 1 AND [Birthday] IS NULL) OR ([Birthday] = @Original_Birthday)));
SELECT idStudent, Name, LastName, Birthday FROM Students WHERE (idStudent = @idStudent)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT idStudent, Name, LastName, Birthday FROM dbo.Students";
        ...
        public virtual int Delete(int Original_idStudent, string Original_Name, string Original_LastName, global::System.Nullable<global::System.DateTime> Original_Birthday) {
        ...
        public virtual int Update(string Name, string LastName, global::System.Nullable<global::System.DateTime> Birthday, int Original_idStudent, string Original_Name, string Original_LastName, global::System.Nullable<global::System.DateTime> Original_Birthday, int idStudent) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string LastName, global::System.Nullable<global::System.DateTime> Birthday, int Original_idStudent, string Original_Name, string Original_LastName, global::System.Nullable<global::System.DateTime> Original_Birthday) {
            return this.Update(Name, LastName, Birthday, Original_idStudent, Original_Name, Original_LastName, Original_Birthday, Original_idStudent);
        }
    }
