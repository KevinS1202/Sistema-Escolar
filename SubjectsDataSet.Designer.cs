...
namespace Sistema_Escolar1.SubjectsDataSetTableAdapters {
    ...
    public partial class SubjectsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Subjects] WHERE (([idSubject] = @Original_idSubject) AND ([Nam" +
                "e] = @Original_Name) AND ([Description] = @Original_Description))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Subjects] ([Name], [Description]) VALUES (@Name, @Description)" +
                ";\r\nSELECT idSubject, Name, Description FROM Subjects WHERE (idSubject = SCOPE_ID" +
                "ENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Subjects] SET [Name] = @Name, [Description] = @Description WHERE (([idSubject] = @Original_idSubject) AND ([Name] = @Original_Name) AND ([Description] = @Original_Description));
SELECT idSubject, Name, Description FROM Subjects WHERE (idSubject = @idSubject)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT idSubject, Name, Description FROM dbo.Subjects";
        ...
        public virtual int Fill(SubjectsDataSet.SubjectsDataTable dataTable) {
        ...
        public virtual SubjectsDataSet.SubjectsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            SubjectsDataSet.SubjectsDataTable dataTable = new SubjectsDataSet.SubjectsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SubjectsDataSet.SubjectsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_idSubject, string Original_Name, string Original_Description) {
        ...
        public virtual int Update(string Name, string Description, int Original_idSubject, string Original_Name, string Original_Description, int idSubject) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(Original_idSubject));
            if ((Original_Name == null)) {
                throw new global::System.ArgumentNullException("Original_Name");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(idSubject));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Description, int Original_idSubject, string Original_Name, string Original_Description) {
            return this.Update(Name, Description, Original_idSubject, Original_Name, Original_Description, Original_idSubject);
        }
    }
